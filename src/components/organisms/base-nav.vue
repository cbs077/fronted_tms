  ...
  >
    ...
    <div class="flex-none">
      <a class="_o6689fn" href="/">
        <div class="hidden md:block">
            <image src="http://tmsweb.mnservice.co.kr/common/img/menu/top_logo.jpg" width="140" height="90"/>    
        </div>
    ...
    <div class="mx-auto flex">
      <base-button
        ...
        :class="{
          'bg-sk-red text-white': menu.active,
        }"
        :text="menu.text"
      />
    </div>
...
const isNavMenu = (value: any): value is INavMenuItem => {
