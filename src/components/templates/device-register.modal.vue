  ...
  >
    <template #modalBody>
      <div class="my-6 flex">
        ...
        />
        <label for="device-register-normal" class="ml-4">일반등록</label>
        <input
          ...
          class="ml-12 translate-y-1 text-black transition"
        />
        <label for="device-register-bulk" class="ml-4">일괄등록</label>
      </div>

      <!-- 일반등록 -->
      <div
        v-show="uploadMethodSelection === '일반등록'"
        class="my-3 grid grid-cols-8"
      >
        <div class="col-span-2 my-auto text-center font-bold">단말기 번호</div>
        <div class="col-span-6 flex">
          <input class="h-10 w-9/12 rounded border border-sk-gray" />

          <base-button class="ml-2 w-2/12" text="중복확인" />
        </div>
      </div>
      ...
      >
        ...
        <div class="col-span-6 flex">
          <div class="flex w-9/12">
            ...
            <div class="my-auto mx-2 w-1/12 text-center">~</div>
            <input class="h-10 w-4/12 rounded border border-sk-gray" />
          </div>
          <base-button class="ml-2 w-2/12" text="중복확인" />
        </div>
      ...
      <div class="my-3 grid grid-cols-8">
        <div class="col-span-2 my-auto text-center font-bold">단말기 모델</div>
        <div class="col-span-6">
          <select-box :items="deviceModels" class="w-3/4" />
        </div>
      </div>
      <div class="my-3 grid grid-cols-8">
        <div class="col-span-2 my-auto text-center font-bold">S/W Group 명</div>
        <div class="col-span-6">
          <select-box :items="swVersions" class="w-3/4" />
        </div>
      </div>
      <div class="my-3 grid grid-cols-8">
        <div class="col-span-2 my-auto text-center font-bold">등록일</div>
        <div class="col-span-6 my-auto">2020-02-02</div>
      </div>
      <div class="my-3 grid grid-cols-8">
        <div class="col-span-2 my-auto text-center font-bold">등록자</div>
        <div class="col-span-6 my-auto">SK TMS</div>
      </div>
    </template>
...
import { DEVICE_REGISTER_TYPE } from "~/@types/enum";
