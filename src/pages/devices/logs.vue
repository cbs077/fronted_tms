<template>
  <div class="mb-4 rounded border border-sk-gray bg-option-background p-3 pl-8">
    <div class="my-3 flex flex-row">
      <div class="my-auto mr-6">업데이트일</div>
      ...
      <div class="my-auto mr-6">모델명</div>

      <select-box :items="deviceModels" class="mr-6 w-72 bg-white" />
    </div>
  ...
  <div class="rounded border border-sk-gray">
    <el-table :data="devices" fit class="rounded">
      ...
      <el-table-column prop="applicationUser" label="등록자" align="center" />
    </el-table>
  </div>
